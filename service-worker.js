const CACHE_VERSION = "celestiframe-shell-v55";
const APP_SHELL = [
  "./",
  "./index.html",
  "./offline.html",
  ...
  "./js/search/search-controller.js?v=42",
  "./js/search/search-core.js?v=42",
  "./js/search/search-worker.js?v=42",
  ...
  "./js/field/field-mode.js?v=45",
  "./js/field/polar-assist.js?v=4",
  "./js/field/celestial-projection.js?v=2",
  "./js/field/magnetic-declination.js?v=1",
