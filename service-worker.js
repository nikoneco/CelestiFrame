const CACHE_VERSION = "celestiframe-shell-v1.8.0";
...
const APP_SHELL = [
  ...
  "./css/app.css?v=1.8.0",
  "./js/app.js?v=1.8.0",
  "./js/config/runtime-config.js?v=1.8.0",
  "./js/config/firebase-config.js?v=1.8.0",
  "./js/state.js?v=1.8.0",
  "./js/astronomy/sun-service.js?v=1.8.0",
  "./js/astronomy/ephemeris-cache.js?v=1.8.0",
  "./js/astronomy/moon-service.js?v=1.8.0",
  "./js/astronomy/milky-way-service.js?v=1.8.0",
  "./js/astronomy/target-catalog.js?v=1.8.0",
  "./js/astronomy/target-service.js?v=1.8.0",
  "./js/geometry/angle.js?v=1.8.0",
  "./js/geometry/bearing.js?v=1.8.0",
  "./js/geometry/destination.js?v=1.8.0",
  "./js/geometry/target-altitude.js?v=1.8.0",
  "./js/elevation/elevation-service.js?v=1.8.0",
  "./js/elevation/elevation-controller.js?v=1.8.0",
  "./js/map/geocoder.js?v=1.8.0",
  "./js/map/map-controller.js?v=1.8.0",
  "./js/map/place-search.js?v=1.8.0",
  "./js/plans/plan-data.js?v=1.8.0",
  "./js/plans/plan-manager.js?v=1.8.0",
  "./js/plans/plan-repository.js?v=1.8.0",
  "./js/map/google-maps-url.js?v=1.8.0",
  "./js/weather/forecast-service.js?v=1.8.0",
  "./js/weather/weather-controller.js?v=1.8.0",
  "./js/light-pollution/light-pollution-controller.js?v=1.8.0",
  "./js/cloud/plan-sync.js?v=1.8.0",
  "./js/cloud/firebase-client.js?v=1.8.0",
  "./js/cloud/firestore-plan-repository.js?v=1.8.0",
  "./js/utils/storage.js?v=1.8.0",
  "./js/cloud/account-controller.js?v=1.8.0",
  "./js/utils/lru-cache.js?v=1.8.0",
  "./js/utils/format.js?v=1.8.0",
  "./js/composition/composition.js?v=1.8.0",
  "./js/search/search-controller.js?v=1.8.0",
  "./js/search/search-core.js?v=1.8.0",
  "./js/search/search-worker.js?v=1.8.0",
  "./js/ui/datetime-controls.js?v=1.8.0",
  "./js/ui/sky-state-rail.js?v=1.8.0",
  "./js/ui/composition-controls.js?v=1.8.0",
  "./js/ui/theme.js?v=1.8.0",
  "./js/ui/target-selector.js?v=1.8.0",
  "./js/pwa/pwa-runtime.js?v=1.8.0",
  "./js/planning/shooting-candidates.js?v=1.8.0",
  "./js/planning/shooting-planner.js?v=1.8.0",
  "./js/terrain/terrain-profile.js?v=1.8.0",
  "./js/terrain/terrain-profile-controller.js?v=1.8.0",
  "./js/field/field-mode.js?v=1.8.0",
  "./js/measurement/observation-height-service.js?v=1.8.0",
  "./js/measurement/observation-camera-service.js?v=1.8.0",
  "./js/measurement/observation-height-controller.js?v=1.8.0",
  "./js/vendor/suncalc.js?v=1.8.0",
  "./js/vendor/astronomy-engine.min.js?v=1.8.0",
];
